...
#"~/Documents/INRA/Projets/SIGNE/2017/globalmatrix"
...
# points(colMeans(perok_final0),col="green")
points(colMeans(perok_finalPLSDA),col="yellow")
legend(ncmax*2/3,15,legend=c("Maha on PLSDA scores", "Maha on LDA+PLSDA scores","predict on LDA+PLSDA scores","Predict PLSDA"),
       col=c("black","red","blue","yellow"), lty=1, cex=0.8)
...
# print("pourcentage d'erreur moyenne de classement des clones par cepage:")
# print(mc_cep)
############ END ############
