...
for (k in 1:s)
  {
  em=paste("~/Documents/INRA/Projets/SIGNE/spectres/2018/GDR2018/",dates[k], sep="")
  # em=paste("~/Documents/INRA/Projets/SIGNE/spectres/2017/",dates[k], sep="")
  w=SIGNE_load(em)
...
brb6="~/Documents/INRA/Projets/SIGNE/spectres/"
