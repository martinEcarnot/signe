...
globalmatrix2 <- read.table("C:/Users/Noémie/Desktop/SFE/Resultats/PTN1/globalmatrix2.csv", header=TRUE, sep=";",dec=".", row.names=1, check.names=FALSE, fileEncoding="latin1")
...
#labs(title = "Graph des valeurs propres", x= "Valeurs propres" , y= "Pourcentage de variabilité expliquée (%)") +
#  theme_minimal()
#print (p)
