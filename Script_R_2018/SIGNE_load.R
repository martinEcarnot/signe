...
user="ME"
if (user=="NL") {source('C:/Users/Noémie/Desktop/SFE/Script_R/asd_read.R')} else {source('/home/ecarnot/Documents/INRA/R/asd_read.R')}


SIGNE_load <- function (d) {
library(asdreader)
#d=choose.dir()
#d="C:\\Users\\No?mie\\Desktop\\SFE\\Pour_Nathan\\Documents_finaux\\test_spectres\\"
